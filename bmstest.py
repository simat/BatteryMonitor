...
configcmd['ChgUTPrel']=b'\x1b'
configcmd['DsgOTPtrig']=b'\x1c'
configcmd['DsgOTPrel']=b'\x1d'
configcmd['DsgUTPtrig']=b'\x1e'
configcmd['DsgUTPrel']=b'\x1f'
configcmd['PackOVPtrig']=b'\x20'
configcmd['PackOVPrel']=b'\x21'
configcmd['PackUVPtrig']=b'\x22'
configcmd['PackUVPrel']=b'\x23'
configcmd['CellOVPtrig']=b'\x24'
configcmd['CellOVPrel']=b'\x25'
configcmd['CellUVPtrig']=b'\x26'
configcmd['CellUVPre']=b'\x27'
...
def switchfets(port='/dev/ttyUSB0'):
  ...
  command = b'\xDD\x5A'+usercmd+crccalc(usercmd).to_bytes(2, byteorder='big')+b'\x77'
  getbmsdat(ser,command)
